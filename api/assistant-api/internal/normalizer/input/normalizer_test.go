...
func newTestNormalizer(t *testing.T, onPacket func(context.Context, ...internal_type.Packet) error) *inputNormalizer {
	t.Helper()
...
func TestInputNormalizer_Normalize_EndOfSpeechBuildsUserInputPacket(t *testing.T) {
	emitted := make([]internal_type.Packet, 0)
	n := newTestNormalizer(t, func(_ context.Context, pkts ...internal_type.Packet) error {
