...
func NewInputNormalizer(logger commons.Logger) internal_type.PacketNormalizer {
...
func (n *inputNormalizer) Initialize(ctx context.Context, communication internal_type.Communication, cfg *protos.ConversationInitialization) error {
