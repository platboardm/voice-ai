...
import { RESEMBLEAI_VOICE } from '@/providers';
import { CustomValueDropdown } from '@/app/components/dropdown/custom-value-dropdown';
export { GetResembleAIDefaultOptions, ValidateResembleAIOptions } from './constant';
...
export const ConfigureResembleAITextToSpeech: React.FC<{
  onParameterChange: (parameters: Metadata[]) => void;
  parameters: Metadata[] | null;
}> = ({ onParameterChange, parameters }) => {
  const [filteredVoices, setFilteredVoices] = useState(RESEMBLEAI_VOICE());
