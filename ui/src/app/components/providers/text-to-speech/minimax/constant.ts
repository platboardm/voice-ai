 ...
 */
import { MINIMAX_MODEL } from '@/providers';
import { SetMetadata } from '@/utils/metadata';
import { Metadata } from '@rapidaai/react';

export const GetMiniMaxDefaultOptions = (current: Metadata[]): Metadata[] => {
  const mtds: Metadata[] = [];
...
export const ValidateMiniMaxOptions = (
  options: Metadata[],
): string | undefined => {
