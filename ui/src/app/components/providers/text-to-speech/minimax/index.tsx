...
import { MINIMAX_MODEL, MINIMAX_VOICE } from '@/providers';
import { CustomValueDropdown } from '@/app/components/dropdown/custom-value-dropdown';
import { Dropdown } from '@/app/components/dropdown';
export { GetMiniMaxDefaultOptions, ValidateMiniMaxOptions } from './constant';
...
export const ConfigureMiniMaxTextToSpeech: React.FC<{
  onParameterChange: (parameters: Metadata[]) => void;
  parameters: Metadata[] | null;
}> = ({ onParameterChange, parameters }) => {
  const [filteredVoices, setFilteredVoices] = useState(MINIMAX_VOICE());
