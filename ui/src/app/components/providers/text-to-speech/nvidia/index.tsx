...
import { NVIDIA_LANGUAGE, NVIDIA_VOICE } from '@/providers';
import { CustomValueDropdown } from '@/app/components/dropdown/custom-value-dropdown';
import { Dropdown } from '@/app/components/dropdown';
export { GetNvidiaDefaultOptions, ValidateNvidiaOptions } from './constant';
...
export const ConfigureNvidiaTextToSpeech: React.FC<{
  onParameterChange: (parameters: Metadata[]) => void;
  parameters: Metadata[] | null;
}> = ({ onParameterChange, parameters }) => {
  const [filteredVoices, setFilteredVoices] = useState(NVIDIA_VOICE());
