...
import { GROQ_TEXT_TO_SPEECH_MODEL, GROQ_VOICE } from '@/providers';
import { CustomValueDropdown } from '@/app/components/dropdown/custom-value-dropdown';
import { Dropdown } from '@/app/components/dropdown';
export { GetGroqDefaultOptions, ValidateGroqOptions } from './constant';
...
export const ConfigureGroqTextToSpeech: React.FC<{
  onParameterChange: (parameters: Metadata[]) => void;
  parameters: Metadata[] | null;
}> = ({ onParameterChange, parameters }) => {
  const [filteredVoices, setFilteredVoices] = useState(GROQ_VOICE());
